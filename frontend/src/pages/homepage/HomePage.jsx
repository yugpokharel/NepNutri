    ...
    <div className="galaxy-scroll">
      ...
      <div className={`cosmic-navbar ${isNavbarVisible ? "visible" : "hidden"}`}>
        ...
        <div className="nav-stellar-links">
          <span onClick={() => navigate("/about")} className="link-star">
            About
          </span>
          <span onClick={() => navigate("/process")} className="link-star">
            Process
          </span>
          <span onClick={() => navigate("/blog")} className="link-star">
            Blog
          </span>
      ...
      <div className="nebula-container">
        ...
        <div className="cosmic-text">
          ...
          <p className="cosmic-description">
            ...
            guide you throughout your journey of weight loss, weight gain, or simply maintaining a balanced and healthy
            lifestyle. Together, we'll help you achieve sustainable results and create habits that last a lifetime.
          </p>
